...
const data = [
  {
    ...
    task_name: "Coding Ui",
    status: "failed",
    assignee: "Giang vien A",
    avatar: "/images/avatars/1.png",
  },
  {
    id: "2",
    task_name: "Handle logic",
    status: "failed",
    assignee: "Giang vien B",
    avatar: "/images/avatars/2.png",
  },
  {
    id: "3",
    task_name: "Connect api",
    status: "failed",
    assignee: "Giang vien C",
    ...
    >
      ...
      <TableCell align="center">
        <Stack direction="row" justifyContent='center' spacing={0.5}>
          <Tooltip title={task?.task_type_id == 1 ? "Task" : "Sub Task"}>{iconTask}</Tooltip>
        </Stack>
      </TableCell>
      <TableCell>
...
const CardListFailed = (props) => {
  const { taskFaileds } = props;
  return (
    <Card>
      <Stack mt={2}>
        <TitleOverview variant="h5" sx={{ color: "#d32f2fd6", }}>
          List failed
        </TitleOverview>
        <TitleOverview variant="subtitle1" sx={{ color: "rgba(0,0,0,0.4)", fontSize: 15, fontWeight: 500}}>
          Tasks have status failed
        </TitleOverview>
      </Stack>
